<template>
  <kinesis-container @click="handleClick">
    <a :class="'flex card-bg items-center border shadow-md rounded-lg flex-row z-40 p-2 space-x-4 space-y-4 night-card-bg' + (theme === 'winter' ? ' border-gray-300' : ' border-zinc-900')">
